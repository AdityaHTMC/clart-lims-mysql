...
const StateList = () => {
  ...
  const { countryList, getCountryList, getStateList, stateList } =
    useCommonContext();
  ...
  return (
    <>
      <CommonBreadcrumb title="State List" parent="Physical" />
      <Container fluid>
        <Row>
          <Col sm="12">
            <Card>
                  ...
                  >
                    ...
                    <tbody>
                      ...
                      {stateList?.data?.length > 0 ? (
                        stateList.data.map((state, index) => (
